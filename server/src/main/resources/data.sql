...
insert into image(image_id, reg_dt, mdf_dt, path, cafe_id) values (6, now(), now(), 'fix/%ED%88%B4%EB%A0%88%EC%95%84-main.jpg', 3);
insert into image(image_id, reg_dt, mdf_dt, path, cafe_id) values (7, now(), now(), 'fix/%ED%88%B4%EB%A0%88%EC%95%84-menu.jpg', 3);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (8, now(), now(), 'fix/%EC%84%AC%EB%9D%B5%EC%96%B4%EB%B0%94%EC%9B%83-main.jpg', 4);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (9, now(), now(), 'fix/%EC%84%AC%EB%9D%B5%EC%96%B4%EB%B0%94%EC%9B%83-menu.jpg', 4);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (10, now(), now(), 'fix/%EC%B9%BC%EB%A6%AC%ED%94%84-main.jpeg', 5);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (11, now(), now(), 'fix/%EC%B9%BC%EB%A6%AC%ED%94%84-menu.jpeg', 5);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (12, now(), now(), 'fix/%EC%97%90%EB%9A%9C%EC%99%88-main.jpg', 6);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (13, now(), now(), 'fix/%EC%97%90%EB%9A%9C%EC%99%88-menu.jpg', 6);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (14, now(), now(), 'fix/%EC%95%8C%EB%B2%A0%EB%A5%B4-main.jpg', 7);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (15, now(), now(), 'fix/%EC%95%8C%EB%B2%A0%EB%A5%B4-menu.jpg', 7);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (16, now(), now(), 'fix/%ED%85%8C%EC%9D%B4%ED%94%84-main_img.png', 8);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (17, now(), now(), 'fix/%ED%85%8C%EC%9D%B4%ED%94%84-menu_img.png', 8);
...
insert into image(image_id, reg_dt, mdf_dt, path, status) values (18, now(), now(), 'fix/LOWIDE-main.jpg', 9);
insert into image(image_id, reg_dt, mdf_dt, path, status) values (19, now(), now(), 'fix/LOWIDE-menu.jpg', 9);
